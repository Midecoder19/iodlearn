...
const Header = () => {
  ...
  const handleSearchResultClick = (result) => {
    ...
    // Removed navigation to notes, PYQs, and important questions as those features are no longer available
  };
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wider font-medium">
                          {result.type} {result.category ? `· ${result.category}` : result.level ? `· ${result.level}` : ""}
                        </div>
                      </div>
                    </button>
                  ))}
