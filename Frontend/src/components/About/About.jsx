            ...
            {[
              {
                ...
                desc: "Learn from mentors with practical, career-focused materials.",
              },
              {
                icon: "ri-question-answer-line",
                color: "text-emerald-500",
                title: "Mentor Support",
                desc: "Get guidance, feedback, and project help from verified mentors.",
              },
              {
                icon: "ri-upload-cloud-line",
                color: "text-pink-500",
                title: "PDF Resources",
                desc: "Access downloadable course resources and materials on demand.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
