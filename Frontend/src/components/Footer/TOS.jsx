        ...
        <motion.div {...fadeUp} className="relative z-10 space-y-8">
          ...
          <div className="space-y-12 text-gray-700 dark:text-indigo-100/80 leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                By accessing or using Iodlearn ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to all of these terms, do not use the Service.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                Iodlearn provides academic resources, including notes and exam preparation materials for students. We reserve the right to modify or discontinue the Service at any time without notice.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                The Service and its original content (excluding user-provided content), features, and functionality are owned by Iodlearn and are protected by international copyright, trademark, and other intellectual property laws.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                In no event shall Iodlearn be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your use of or inability to use the Service.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                <br />
                <a href="mailto:iodlearn.com@gmail.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">
